...
r_refs("r_references.bib") # creates bib to cite the used R packages
...
```{r import, echo=FALSE, message=FALSE, warning=FALSE}
  # Please set your working directory using the drop down menu above
  # Then put this file in this directory, as well as the data.Rda file
...
## Data analysis
We used `r cite_r("r_references.bib")` for all our analyses.
...
```{r consistency, echo=FALSE, message=FALSE, warning=FALSE}
