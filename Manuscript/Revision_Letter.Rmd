...
And if the focus in burnout studies with teacher samples has been on the DP and EE subscales, it is all the more reason to focus on the RPE subscale, especially because NFC was equally correlated with all MBI subscales in our teacher sample.
...
Since we have not preregistered any analysis of the association between NFC and DP or EE, and we do not have theory-driven hypotheses regarding these associations,  we do not believe that such analyses would contribute to the goals of the paper.
