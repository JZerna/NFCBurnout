...
Following Grass et al. [-@Grass2018], bootstrapped confidence intervals with $N=2,000$ replicates <!-- add seed and RNG (likely "Mersenne-Twister" -->w ere computed to account for deviations from normality.
