...
To sum up, this study had three aims: Replicating findings of mediation between NFC and burnout in a teacher sample, investigating the impact of different demand-resource-ratios on the relationship between NFC and burnout, and exploring the impact of other variables such as perceived burden by the Covid-19 pandemic.
...
To achieve this, we replicated findings of mediators between Need for Cognition and burnout in a teacher sample, and extended the analysis to the role of different ratios of demands and resources in burnout using latent variable models.
