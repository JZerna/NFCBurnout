...
Using traditional cut-off values [@Nunnally1994], the Cronbach's Alpha values of the three demand-resource-ratios can be considered *acceptable*.
Even though these cut-offs have been criticized for being both arbitrary and insensitive to violations of internal consistency [@Dunn2014; @Taber2018], the more robust MacDonald's Omega [@Dunn2014] actually indicates *acceptable* to *good* internal consistency.
