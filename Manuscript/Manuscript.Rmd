...
```{r objective1_table, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  fit_table <- data.frame("Path" = c("NFC $\\rightarrow$ Self Control", "NFC $\\rightarrow$ Reappraisal", "NFC $\\rightarrow$ Suppression",
                                   ...
                                   "Total Effect"),
                          "Effect" = c(fit_summ$PE$est[fit_summ$PE$label != "" & fit_summ$PE$label != "Contrast"]),
  ...
  replication_table <-
    ...
    footnote(general = "CI = confidence interval, RPE = reduced personal efficacy subscale of the Maslach Burnout Inventory, SE = standard error.",
             escape = F, # correctly print special characters
             threeparttable = T)# line breaks in the footnote
