...
```{r explor2_plot, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  fit_explor2_param <- fit_explor2_summ$PE$std.all[c(1:10,16:32)]
  fit_explor2_sign <- c(rep(1,10), fit_explor2_summ$PE$pvalue[16:32])
  ...
  fit_explor2_plot <- semPaths(fit_explor2, what = "std",
                        nodeLabels = c("nfc1","nfc2","nfc3","nfc4",
                                       ...
                                       "DRF","DTH",
                                       "MBI_EE","MBI_RPE"),
                        layout = matrix(data = c(-0.7,-0.56,-0.44,-0.3,
