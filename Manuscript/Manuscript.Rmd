...
NFC can easily be assessed using the Need for Cognition Scale (NCS), a self-report questionnaire with 18 to 34 items [@Cacioppo1982; @Cacioppo1984]. <!-- den Satz würde ich entweder weglassen oder noch die deutsche NFC Skala mit referenzieren -->
While many studies have found positive associations of NFC with academic performance [@Cazan2014; @Elias2002; @Grass2017; @Lavrijsen2021; @Zheng2020]<!-- von Stumm & Ackerman, 2013 als Metaanalyse mit aufnehmen, dafür 1-2 Einzelstudien raus -->, recent investigations have also looked at NFC as a personal resource in academic and work contexts.
...
These findings suggest that individuals high in NFC might be less prone to experience adverse effects of work stress, which range from physical [@Dragano2017; @Steptoe2013] to psychological [@Madsen2017; @Maslach2016; @Wiesner2005] consequences.
