...
The Covid-19 items can be found in the *Supplementary Material S1*.
...
```{r objective1yearsplot, echo=FALSE, message=FALSE, warning=FALSE, fig.pos="H", fig.cap="Replication of Grass et al. (2018) when including years spent teaching"}
...
```{r exploratory1plot, echo=FALSE, message=FALSE, warning=FALSE, fig.pos="H", fig.cap="Demand-resource-ratio model with the MBI subscale reduced personal efficacy"}
