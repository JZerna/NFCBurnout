...
```{r setup, include = FALSE}
  ...
  packages = c("bibtex", "here", "tidyverse", "bayestestR", "papaja", "lavaan", "psych", "MVN", "MBESS",
               "kableExtra", "Hmisc", "semPlot", "ggplot2", "knitr", "qgraph", "ppcor")
  ...
  # those two libraries come from packages with different names, so we load them individually
...
```{r objective1table, echo=FALSE, message=FALSE, warning=FALSE, caption="Results of the replication of Grass et al. (2018)"}
  ...
  Table3 <- data.frame("Path" = c("NFC on Self Control", "NFC on Reappraisal", "NFC on Suppression",
...
```{r objective1plot, echo=FALSE, message=FALSE, warning=FALSE, fig.pos="H", fig.cap="Replication of Grass et al. (2018)"}
...
```{r objective1yearstable, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  Table4 <- data.frame("Path" = c("NFC on Self Control", "Years spent teaching on Self Control",
...
```{r objective1yearsplot, echo=FALSE, message=FALSE, warning=FALSE, fig.show='hide'}
...
```{r objective2plot, echo=FALSE, message=FALSE, warning=FALSE, fig.pos="H", fig.cap="Mediation of NFC and burnout by demand-resource-ratios"}
...
```{r objective2table, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  Table5 <- data.frame("Path" = c("NFC on DTH", "NFC on DTL", "NFC on DRF", "NFC on MBI",
...
```{r exploratory1plot, echo=FALSE, message=FALSE, warning=FALSE, fig.show='hide'}
...
```{r exploratory1table, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  TableS1 <- data.frame("Path" = c("NFC on DTH", "NFC on DTL", "NFC on DRF", "NFC on RPE",
...
```{r explor2plot, echo=FALSE, message=FALSE, warning=FALSE, fig.pos="H", fig.cap="Exploratory analysis of variable relations"}
...
```{r explor2table, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  TableS2 <- data.frame("Path" = c("Years on COVB", "Years on SCS",
