...
Additionally, NFC was negative associated with habitual use of suppression ($\beta = $`r round(fit_summ$PE$std.all[fit_summ$PE$label == "c1"], digits = 2)`, $p = $`r round(fit_summ$PE$pvalue[fit_summ$PE$label == "c1"], digits = 3)`), which was not the case in the study by Grass et al. [-@Grass2018].
